...
teacher_timetable = {
	"ГРИГОРЬЕВА ВИКТОРИЯ ВЛАДИМИРОВНА": {
		"even": {
			"пн": [
				{"time": "11.20", "subject": "Математика", "type": "пр", "house": "7", "group": "4138"}
				{"time": "12.50", "subject": "Математика", "type": "пр", "house": "7", "group": "4134"}
				{"time": "13.30", "subject": "Математика", "type": "пр", "house": "7", "group": "4140"}
			]
		}
	}
}
...
def get_teachers_timetable():
	...
	for row in sheet:
		...
		if date == None:
			timetable[teacher]["even"][day].append(data)
			timetable[teacher]["odd"][day].append(data)
